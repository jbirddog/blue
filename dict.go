...
func DefaultDictionary() *Dictionary {
	...
	d.appendWords([]*Word{
		...
		NewCallGoWord("decw(", KernelDecwLParen).Immediate(),
		...
		NewCallGoWord("litw", KernelLitw).Immediate(),
		...
		NewCallGoWord("litw(", KernelLitwLParen).Immediate(),
